...
namespace HotelBookingSystemAPI.Contexts
{
    public class HotelBookingContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //.Property(rt => rt.Type)
            //.HasConversion(
            //    t => (int)t, // Convert enum to integer
            //    t => (RoomTypes)Enum.ToObject(typeof(RoomTypes), t));

            modelBuilder.Entity<BookedRooms>().HasKey(br => new { br.BookingId, br.RoomId });

            //modelBuilder.Entity<Discount>().HasKey(d => new { d.HotelId, d.RType });

            //modelBuilder.Entity<RoomType>().HasKey(rt => new { rt.HotelId, rt.Type });
